...
f = go.FigureWidget()
colors = ["red", "LightCoral", "CornflowerBlue", "blue","Yellow","Orange","grey","grey", "grey", "grey", "grey", "grey", "grey", "grey", "grey"]

i=0
fontsize = st.sidebar.slider("Adjust text size", 8, 20, 16)
for c in df.columns:
    f.add_trace(
        go.Scatter(
    ...
    i = i+1
f.update_layout(height=700, xaxis_tickfont_size=fontsize, yaxis_tickfont_size=fontsize)
